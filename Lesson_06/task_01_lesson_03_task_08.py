...
"""
/usr/bin/python3.5 /home/bocharick/HDD/UbuntuFiles/PycharmProjects/GeekBrains_AI_Algorithms/Lesson_06/task_01_lesson_03_task_08.py
...
================================================================================
Данные о переменных:
	 Имя переменной = ['matrx']; тип = <class 'list'>; размер = 128; содержимое =  [[1, 2, 3, 6], [4, 5, 6, 15], [7, 8, 9, 24], [0, 10, 11, 21], [12, 13, 14, 39]]
		 Имя переменной = []; тип = <class 'list'>; размер = 96; содержимое =  [1, 2, 3, 6]
		 ...
		 Имя переменной = []; тип = <class 'list'>; размер = 96; содержимое =  [4, 5, 6, 15]
		 ...
		 Имя переменной = []; тип = <class 'list'>; размер = 96; содержимое =  [7, 8, 9, 24]
		 ...
		 Имя переменной = []; тип = <class 'list'>; размер = 96; содержимое =  [0, 10, 11, 21]
		 ...
		 Имя переменной = ['line']; тип = <class 'list'>; размер = 96; содержимое =  [12, 13, 14, 39]
...
================================================================================
Суммарный размер всех переменных из списка: 1164
"""
